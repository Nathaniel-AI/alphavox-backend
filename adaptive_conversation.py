...
COMPLEXITY_LEVELS = {
    ...
    3: {"name": "Moderate", "description": "Balanced vocabulary and sentence structures"},
    4: {"name": "Advanced", "description": "Complex vocabulary and varied sentence structures"},
    5: {"name": "Expert", "description": "Sophisticated vocabulary and complex sentence structures"}
}
...
class ConversationComplexityEngine:
    ...
    def determine_response_complexity(self, 
                                    user_id: str, 
        ...
        if adaptation_mode == "fixed":
            ...
            if adjustments:
                ...
                weighted_complexity = (base_complexity * 0.6) + (sum(adjustments) / len(adjustments) * 0.4)
        ...
        if target_complexity <= 2:
            ...
            for sentence in sentences:
                ...
                if len(words) > 10:
                    ...
                    breaks = [i for i, word in enumerate(words) 
