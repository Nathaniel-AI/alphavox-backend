...
class RealEyeTrackingService:
    ...
    def start_tracking(self) -> bool:
        ...
        try:
            ...
            logger.info(f"Camera initialized with frame size: {self.frame_width}x{self.frame_height}")
        except Exception as e:
            ...
            if self.face_found:
                ...
                if len(eyes) >= 2:
                    ...
                    if self.debug_mode:
                        ...
                        cv2.rectangle(frame, (x + lx, y + ly), (x + lx + lw, y + ly + lh), (0, 255, 0), 2)
                    ...
                    self.current_region = self._get_region(self.current_position['x'], self.current_position['y'])
                    ...
                    if len(eyes) < 2 and self.left_eye and self.right_eye:
                        ...
                        current_time = time.time()
                        if current_time - self.last_blink_time > 0.5:  # Prevent rapid consecutive blinks
    ...
    def process_camera_frame(self, frame):
        ...
        if self.face_found:
            ...
            cv2.putText(output_frame, f"Region: {self.current_region}", (10, 30),
                       cv2.FONT_HERSHEY_SIMPLEX, 0.7, (255, 255, 255), 2)
            
            # Add blink detection indicator
            if self.blink_detected:
                cv2.putText(output_frame, "BLINK!", (10, 60),
