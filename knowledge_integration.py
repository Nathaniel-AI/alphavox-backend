...
class KnowledgeIntegration:
    ...
    def __init__(self):
        ...
        self.knowledge_graph_file = os.path.join(self.knowledge_base_dir, "knowledge_graph.json")
    ...
    def _load_knowledge_base(self):
        ...
        if os.path.exists(self.knowledge_graph_file):
            try:
                ...
                logger.info(f"Loaded knowledge graph with {len(self.knowledge_graph)} nodes")
            except Exception as e:
                logger.error(f"Error loading knowledge graph: {e}")
    
    def query_knowledge_base(self, query: str, topic: Optional[str] = None, 
    ...
    def get_related_topics(self, topic: str, limit: int = 5) -> List[str]:
        ...
        """
        if self.knowledge_engine and hasattr(self.knowledge_engine, 'get_related_topics'):
            try:
