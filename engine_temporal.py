...
class TemporalNonverbalEngine:
    ...
    def _load_lstm_models(self):
        ...
        if os.path.exists(emotion_labels_path):
            try:
                ...
                self.labels['emotion'] = ['Neutral', 'Happy', 'Sad', 'Angry', 'Fear', 'Surprise']
        else:
    ...
    def classify_gesture_sequence(self):
        ...
        if self.models['gesture'] is None or len(self.gesture_buffer) < self.sequence_length:
            return {'expression': 'Unknown', 'intent': 'Unknown', 'confidence': 0.0, 'message': 'I don\'t understand.'}
        ...
        expression_data = self.language_map.get(gesture, {'intent': 'Unknown', 'message': 'I don\'t understand.'})
    ...
    def classify_eye_movement_sequence(self):
        ...
        # Get intent and message from language map
        expression_data = self.language_map.get(eye_expression, {'intent': 'Unknown', 'message': 'I don\'t understand.'})
    ...
    def classify_emotion_sequence(self):
        ...
        # Get intent and message from language map
        expression_data = self.language_map.get(emotion, {'intent': 'Unknown', 'message': 'I don\'t understand.'})
    ...
    def set_conversation_persona(self, persona):
        ...
        """
        valid_personas = ["default", "academic", "clinical", "supportive", "child-friendly"]
