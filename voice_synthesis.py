...
class VoiceSynthesizer:
    ...
    def text_to_speech(self, text, language=None, accent=None, slow=None, play=True, save_path=None):
        """
    ...
    def set_defaults(self, language=None, accent=None, slow=None):
        ...
        if language:
            if language in self.available_languages:
                ...
                logger.warning(f"Language '{language}' not available, using current default: {self.default_language}")
        ...
        logger.info(f"Default settings updated: language={self.default_language}, " +
    ...
    def speak_with_emotion(self, text, emotion=None, emotion_intensity=None, language=None, accent=None):
        """
